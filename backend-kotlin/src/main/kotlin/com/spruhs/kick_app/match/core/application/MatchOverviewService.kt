...
class MatchOverviewService(
    ...
    suspend fun getMatchHistory(groupId: GroupId): MatchOverview {
        return matchOverviewPersistencePort.getOverview(groupId) ?: createNewMatchOverview(groupId)
    }
    ...
    private suspend fun createNewMatchOverview(groupId: GroupId): MatchOverview {
        return MatchOverview(groupId)
    }
}
