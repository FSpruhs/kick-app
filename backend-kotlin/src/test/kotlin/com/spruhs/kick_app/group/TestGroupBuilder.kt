...
class TestGroupBuilder {
    ...
    fun toInvitedUserResponseCommand(
        requestingUser: UserId,
        response: Boolean,
    ...
    fun toInvitedUserResponse(response: Boolean) =
        InviteUserResponse(
    ...
    fun withPlayers(players: List<Player>) = also { this.players = players }
