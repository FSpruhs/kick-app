...
class MessageUseCasesTest {
    ...
    fun `send should send message`(expectedMessage: Message): Unit =
        runBlocking {
            // Given
            val messageParams =
                MessageParams(
    ...
    @Test
    fun `getByUser should return messages for user`(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun `markAsRead should mark message as read`(): Unit =
        runBlocking {
            // Given
