...
class MatchProjectionMongoDBTest : AbstractMongoTest() {
    ...
    @Test
    fun `save should find match`(): Unit =
        runBlocking {
            // Given
    ...
    @ParameterizedTest
    @MethodSource("data")
    fun `findAllByGroupId should find all with filter`(data: TestData): Unit =
        runBlocking {
            // Given
                ...
                TestData(
                    matches =
                        listOf(
                            ...
                            TestMatchBuilder()
                                .withId("match2")
                                .withStart(LocalDateTime.now().plusDays(3))
                                .withGroupId("group1")
                                .toProjection(),
                            TestMatchBuilder()
                                .withId("match3")
                                .withStart(LocalDateTime.now().plusDays(4))
                                .withGroupId("group1")
                                .toProjection(),
                            TestMatchBuilder()
                                .withId("match4")
                            ...
                            TestMatchBuilder()
                                .withId("match6")
                                .withStart(LocalDateTime.now().plusDays(6))
                                .withGroupId("group2")
                                .toProjection(),
                        ),
