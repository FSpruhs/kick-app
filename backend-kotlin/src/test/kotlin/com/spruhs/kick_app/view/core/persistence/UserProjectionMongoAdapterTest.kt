...
class UserProjectionMongoAdapterTest : AbstractMongoTest() {
    ...
    @Test
    fun `save should save user`(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun `getUser should return null for non-existing user`(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun `findByGroupId should return group`(): Unit =
        runBlocking {
            // Given
            val group1 =
                UserGroupProjection(
    ...
    @Test
    fun `existsByEmail should return true for existing email`(): Unit =
        runBlocking {
            // Given
            val user1 =
                TestUserBuilder()
    ...
    @Test
    fun `existsByEmail should return false for non-existing email`(): Unit =
        runBlocking {
            // Given
            val user1 =
                TestUserBuilder()
