...
class GroupApiServiceTest {
    ...
    @Test
    fun `isActiveMember should return true when member active`(): Unit =
        runBlocking {
            // Given
            val group =
                TestGroupBuilder()
    ...
    @Test
    fun `isActiveMember should return false when member not exists`(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun `isActiveCoach should return true when member active`(): Unit =
        runBlocking {
            // Given
            val group =
                TestGroupBuilder()
    ...
    @Test
    fun `isActiveCoach should return false when member not exists`(): Unit =
        runBlocking {
            // Given
            val group = TestGroupBuilder().buildProjection()
    ...
    @Test
    fun `getActivePlayers should return active player`(): Unit =
        runBlocking {
            // Given
            val group =
                TestGroupBuilder()
