...
class MatchServiceTest {
    ...
    @Test
    fun `getMatch should get match`(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun `getMatch should throw exception when match not exists`(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun `getMatch should throw exception when user not verified`(): Unit =
        runBlocking {
            // Given
            val userId = UserId("test-user")
            val match = TestMatchBuilder().toProjection()
    ...
    @Test
    fun `getMatchesByGroup should get matches`(): Unit =
        runBlocking {
            // Given
            val match = TestMatchBuilder().toProjection()
            val userId = UserId("test-user")
    ...
    @Test
    fun `getMatchesByGroup should throw exception when user not verified`(): Unit =
        runBlocking {
            // Given
            val userId = UserId("test-user")
            val match = TestMatchBuilder().toProjection()
    ...
    @Test
    fun `getPlayerMatches should get matches`(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun `whenEvent should handle match planned event`(): Unit =
        runBlocking {
            // Given
            val match = TestMatchBuilder().toProjection()
            val event =
    ...
    @Test
    fun `whenEvent should handle player added to cadre event`(): Unit =
        runBlocking {
            // Given
            val match = TestMatchBuilder().toProjection()
            val event =
    ...
    @Test
    fun `whenEvent should handle player deregistered event`(): Unit =
        runBlocking {
            // Given
            val match = TestMatchBuilder().toProjection()
            val event =
                PlayerDeregisteredEvent(
                    aggregateId = match.id.value,
    ...
    @Test
    fun `whenEvent should handle player placed on waiting bench event`(): Unit =
        runBlocking {
            // Given
            val match = TestMatchBuilder().toProjection()
            val event =
    ...
    @Test
    fun `when event should handle match canceled event`(): Unit =
        runBlocking {
            // Given
            val match = TestMatchBuilder().toProjection()
            val event =
    ...
    @Test
    fun `whenEvent should handle playground changed event`(): Unit =
        runBlocking {
            // Given
            val match = TestMatchBuilder().toProjection()
    ...
    @Test
    fun `whenEvent should handle match result entered event`(): Unit =
        runBlocking {
            // Given
            val match = TestMatchBuilder().toProjection()
            val event =
