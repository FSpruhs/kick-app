...
class StatisticServiceTest {
    ...
    @Test
    fun `getPlayerStatistics should get statistics`(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun `getPlayerStatistics should throw exception when requester not authorized`(): Unit =
        runBlocking {
            // Given
            val requestingUser = UserId("requestingUserId")
    ...
    @Test
    fun `getPlayerStatistics should throw exception when player not found`(): Unit =
        runBlocking {
            // Given
            val statistics = TestStatisticBuilder().build()
            val requestingUser = UserId("requestingUserId")
    ...
    @Test
    fun `whenEvent should handle group created event`(): Unit =
        runBlocking {
            // Given
            val event =
                GroupCreatedEvent(
    ...
    @Test
    fun `whenEvent should handle player entered group event`(): Unit =
        runBlocking {
            // Given
            val event =
    ...
    @Test
    fun `whenEvent should handle player entered group second time event`(): Unit =
        runBlocking {
            // Given
            val event =
                PlayerEnteredGroupEvent(
    ...
    @Test
    fun `whenEvent should handle first result entered event`(): Unit =
        runBlocking {
            // Given
            val event =
            ...
            coEvery {
                statisticRepository.save(
                    TestStatisticBuilder()
                        .withUserId(event.players[1].userId)
                        .withTotalMatches(11)
                        .withLosses(4)
                        .build(),
                )
            ...
            coEvery {
                statisticRepository.save(
                    TestStatisticBuilder()
                        .withUserId(event.players[2].userId)
                        .withTotalMatches(11)
                        .withDraws(3)
                        .build(),
                )
    ...
    @Test
    fun `whenEvent should handle first result entered with new player event`(): Unit =
        runBlocking {
            // Given
            val event =
                MatchResultEnteredEvent(
    ...
    @Test
    fun `whenEvent should handle another result entered event old player not exists`(): Unit =
        runBlocking {
            // Given
            val event =
                MatchResultEnteredEvent(
    ...
    @Test
    fun `whenEvent should handle another result entered event with new player`(): Unit =
        runBlocking {
            // Given
            val event =
                MatchResultEnteredEvent(
    ...
    @Test
    fun `whenEvent should not save when same result`(): Unit =
        runBlocking {
            // Given
            val event =
                MatchResultEnteredEvent(
    ...
    @Test
    fun `whenEvent should delete result from not existing player`(): Unit =
        runBlocking {
            // Given
            val event =
                MatchResultEnteredEvent(
