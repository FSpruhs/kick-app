...
class UserServiceTest {
    ...
    @Test
    fun `getUser should get user`(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun `getUser should throw UserNotFoundException when user not found`(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun `whenEvent should handle user created`(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun `whenEvent should handle nick name changed event`(): Unit =
        runBlocking {
            // Given
            val user = minimalUserProjection()
    ...
    @Test
    fun `whenEvent should handle group name changed event`(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun `whenEvent should handle match result entered event with new last match`(): Unit =
        runBlocking {
            // Given
            val user = TestUserBuilder().buildProjection()
            val event =
    ...
    @Test
    fun `whenEvent should handle match result entered event with no new last match`(): Unit =
        runBlocking {
            // Given
            val user = TestUserBuilder().buildProjection()
            val event =
    ...
    @Test
    fun `whenEvent should handle match result entered event with first last match`(): Unit =
        runBlocking {
            // Given
            val user =
                TestUserBuilder()
    ...
    fun `whenEvent should handle player status events`(data: TestPlayerStatusData): Unit =
        runBlocking {
            // Given
    ...
    fun `whenEvent should handle player role events`(data: TestPlayerRoleData): Unit =
        runBlocking {
            // Given
            val user = TestUserBuilder().withGroups(listOf(data.group)).buildProjection()
